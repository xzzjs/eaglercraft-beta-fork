...
extends Gui {
    ...
    public void func_22069_a(int n, int n2, int n3) {
        boolean bl;
        boolean bl2 = bl = this.field_22081_b && n >= this.field_22079_d && n < this.field_22079_d + this.field_22077_f && n2 >= this.field_22078_e && n2 < this.field_22078_e + this.field_22076_g;
    ...
    public void func_22067_c() {
        ...
        if (this.field_22081_b) {
            ...
            this.drawString(this.field_22080_c, this.field_22075_h + (bl ? "_" : ""), this.field_22079_d + 4, this.field_22078_e + (this.field_22076_g - 8) / 2, 0xE0E0E0);
        } else {
            this.drawString(this.field_22080_c, this.field_22075_h, this.field_22079_d + 4, this.field_22078_e + (this.field_22076_g - 8) / 2, 0x707070);
        }
    }
