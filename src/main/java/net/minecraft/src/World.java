    ...
    implements IBlockAccess
{
    ...
    public World(ISaveHandler isavehandler, String s, long l, WorldProvider worldprovider)
    {
        ...
        if(worldinfo != null && worldinfo.func_22290_i() == -1)
        {
    ...
    {
        worldinfo.func_22292_a(chunkcoordinates.field_22395_a, chunkcoordinates.field_22394_b, chunkcoordinates.field_22396_c);
    }
